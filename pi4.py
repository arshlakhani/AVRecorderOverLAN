...
def execute_code():
    # Your code to execute when the URL is online and button is pressed
    print("URL is online and button pressed! Executing code...")
    portnum = 5001  # Change to the desired port number
...
if __name__ == '__main__':
    ...
    button_pin = 18  # The GPIO pin connected to the button
    GPIO.setup(button_pin, GPIO.IN, pull_up_down=GPIO.PUD_UP)  # Set pin as input with a pull-up resistor
